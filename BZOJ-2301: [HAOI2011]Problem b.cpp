...
/// We will use this technique to find out this solution .
/// problem link - http://www.lydsy.com/JudgeOnline/problem.php?id=2301
...
int main()
{
   ...
   ll a,b,c,d,k;
   cin>>a>>b>>c>>d>>k;
   ll inclusion1=calculation(b,d,k);
   ll inclusion2=calculation(a-1,c-1,k);///it will be deleted two times so add it one time again
   ll exclusion1=calculation(a-1,d,k);
   ll exclusion2=calculation(b,c-1,k);
   ll ans=(inclusion1+inclusion2)-(exclusion1+exclusion2);
   cout<<ans<<endl;
   }
   return 0;
}
